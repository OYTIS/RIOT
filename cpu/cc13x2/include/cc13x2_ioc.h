...
/**
 * @ingroup         cpu_cc13x2_ioc_definitions
 * @{
 *
 * @file
 * @brief           CC13x2 MCU I/O register definitions
 *
...
#define IOC ((cc13x2_ioc_regs_t *)(MCU_IOC_BASE)) /**< IOC register banks */
...
#define IOCFG_PORTID_UART1_RX           0x00000013  /**< UART0 receive */
#define IOCFG_PORTID_UART1_TX           0x00000014  /**< UART0 transmit */
#define IOCFG_PORTID_UART1_CTS          0x00000015  /**< UART0 clear to send */
#define IOCFG_PORTID_UART1_RTS          0x00000016  /**< UART0 request to send */
 ...
 * @{
 */
#define AON_IOC_BASE            (0x40094000) /**< always-on-IOC base address */
/** @} */
